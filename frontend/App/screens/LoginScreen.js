...
import { saveAccessToken, saveRefreshToken, saveUserInfo } from '../services/storage';
...
const LoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    if (!phoneRegex.test(phoneNumber)) {
      showNotification('Lỗi', 'Số điện thoại không hợp lệ. Vui lòng nhập số điện thoại 10 chữ số bắt đầu bằng số 0');
      return;
    }
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.notificationModalContent}>
              ...
              <View style={styles.notificationBody}>
                <Text style={styles.notificationMessage}>{notificationModal.message}</Text>
              </View>
              
              <View style={styles.notificationFooter}>
                {notificationModal.actions && notificationModal.actions.length > 0 ? (
                  notificationModal.actions.map((action, index) => (
                    <TouchableOpacity
                      key={index}
                      style={[
                        styles.notificationButton,
                        index === notificationModal.actions.length - 1 && styles.primaryButton
                      ]}
                    ...
                    >
                      <Text 
                        style={[
                          ...
                          index === notificationModal.actions.length - 1 && styles.primaryButtonText
                        ]}
                      >
                        {action.text}
                      </Text>
                  ...
                  >
                    <Text style={[styles.notificationButtonText, styles.primaryButtonText]}>Đóng</Text>
                  </TouchableOpacity>
                )}
              </View>
            </View>
